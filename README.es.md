...
_Dashboard de métricas financieras con frontend en Next.js + TypeScript y backend en FastAPI._
...
Si necesitas apuntar a otro backend, define `NEXT_API_BASE_URL`.
